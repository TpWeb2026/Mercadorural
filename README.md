...
3. Una vez ya ubicados en la carpeta, tenemos que ejecutar el comando de: go run       main.go
   Si todo funciona bien, en la terminal, tendria que aparecer un mensaje que diga     "Servidor escuchando en http://localhost:8080"

4. Si el mensaje anterior aparecio en la terminal, estamos en condicones de abrir      el un navegador, el de tu preferencia y en la barra de busqueda, escribir lo        siguiente:
   http://localhost:8080
   eso mostrara la pagina web que hemos creado.
   
5. Para terminar de cerrar, tenemos que detener el servidor, lo cual se hace,         volviendo a la terminal que estuvimos usando, donde nos aparece el mensaje de
